...
This skill adapts Andrej Karpathy's autoresearch methodology for autonomous experimentation loops.

The implementation and skill structure is based on work by [@itsolelehmann](https://x.com/itsolelehmann), who adapted Karpathy's method for Claude Code skills and demonstrated it improving a landing page copy skill from 56% to 92% pass rate.
